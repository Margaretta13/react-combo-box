...
else{window.ReactComboBox={ComboBox:definition()};}})(function(){"use strict";var ItemParserMixin={getValueOfItem:function(item,titleField){var value=titleField?item[titleField]:item;return value;}};var EventHandlersMixin={keyCodes:{ESCAPE:27,ARROW_DOWN:40,ARROW_UP:38,ENTER:13},handleInputChange:function(event){var value=event.target.value;this.setProps({value:value});this.filterItems(value);if(this.onChange){this.onChange(value);}},handleArrowClick:function(){if(this.props.disabled){return false;}
